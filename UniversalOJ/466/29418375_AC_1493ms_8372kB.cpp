...
namespace am {
    struct matrix {
        ...
        inline void operator += (const matrix &other) {
			if (other.a[0][0] > a[0][0]) a[0][0] = other.a[0][0];
			if (other.a[0][1] > a[0][1]) a[0][1] = other.a[0][1];
			if (other.a[0][2] > a[0][2]) a[0][2] = other.a[0][2];
			if (other.a[1][0] > a[1][0]) a[1][0] = other.a[1][0];
			if (other.a[1][1] > a[1][1]) a[1][1] = other.a[1][1];
			if (other.a[1][2] > a[1][2]) a[1][2] = other.a[1][2];
			if (other.a[2][0] > a[2][0]) a[2][0] = other.a[2][0];
			if (other.a[2][1] > a[2][1]) a[2][1] = other.a[2][1];
			if (other.a[2][2] > a[2][2]) a[2][2] = other.a[2][2];
        }
        inline bool operator == (const matrix &other) const {
			if (a[0][0] != other.a[0][0]) return false;
			if (a[0][1] != other.a[0][1]) return false;
			if (a[0][2] != other.a[0][2]) return false;
			if (a[1][0] != other.a[1][0]) return false;
			if (a[1][1] != other.a[1][1]) return false;
			if (a[1][2] != other.a[1][2]) return false;
			if (a[2][0] != other.a[2][0]) return false;
			if (a[2][1] != other.a[2][1]) return false;
			if (a[2][2] != other.a[2][2]) return false;
            return true;
        }
        inline bool operator < (const matrix &other) const {
			if (a[0][0] != other.a[0][0]) return a[0][0] < other.a[0][0];
			if (a[0][1] != other.a[0][1]) return a[0][1] < other.a[0][1];
			if (a[0][2] != other.a[0][2]) return a[0][2] < other.a[0][2];
			if (a[1][0] != other.a[1][0]) return a[1][0] < other.a[1][0];
			if (a[1][1] != other.a[1][1]) return a[1][1] < other.a[1][1];
			if (a[1][2] != other.a[1][2]) return a[1][2] < other.a[1][2];
			if (a[2][0] != other.a[2][0]) return a[2][0] < other.a[2][0];
			if (a[2][1] != other.a[2][1]) return a[2][1] < other.a[2][1];
			if (a[2][2] != other.a[2][2]) return a[2][2] < other.a[2][2];
            return false;
        }
