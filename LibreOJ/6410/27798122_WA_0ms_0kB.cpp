...
inline bool cross(const line &a,const line &b){
  // printf("cross %d %d %d %d : %d %d %d %d => %d %d %d %d\n",a.x1,a.y1,a.x2,a.y2,b.x1,b.y1,b.x2,b.y2,
  //   right(a.x2-a.x1,a.y2-a.y1,b.x1-a.x1,b.y1-a.x1),right(a.x2-a.x1,a.x2-a.y1,b.x2-a.x1,b.y2-a.y1),
  //   right(b.x2-b.x1,b.y2-b.y1,a.x1-b.x1,a.y1-b.y1),right(b.x2-b.x1,b.y2-b.y1,a.x2-b.x1,a.y2-b.y1));
  return (right(a.x2-a.x1,a.y2-a.y1,b.x1-a.x1,b.y1-a.x1)^right(a.x2-a.x1,a.x2-a.y1,b.x2-a.x1,b.y2-a.y1))&&
    (right(b.x2-b.x1,b.y2-b.y1,a.x1-b.x1,a.y1-b.y1)^right(b.x2-b.x1,b.y2-b.y1,a.x2-b.x1,a.y2-b.y1));
}
