...
namespace quad_residue{
  ...
  inline vec2 cross(const vec2 &a,const vec2 &b,i32 mod){
    // cerr<<"cross "<<a.r<<" "<<a.i<<" | "<<b.r<<" "<<b.i<<" | "<<(i32)(((i64)a.r*b.r+(i64)a.i*b.i%mod*d)%mod)<<" "<<(i32)(((i64)a.r*b.i+(i64)a.i*b.r)%mod)<<endl;
    return {(i32)(((i64)a.r*b.r+(i64)a.i*b.i%mod*d)%mod),(i32)(((i64)a.r*b.i+(i64)a.i*b.r)%mod)};
  }
  ...
  inline i32 cipolla(i32 n,i32 mod){
    ...
    // cerr<<"??? "<<a<<" "<<d<<" "<<legendre(d,mod)<<" "<<mod<<endl;
...
constexpr long long mod=1000000000000000009;
...
struct bigint{
  ...
  template<class T> inline T operator%(const T &mod)const{
    T res=0;
...
inline long long dec(long long a,long long b){return (a-=b)<0?a+mod:a;}
inline long long inc(long long a,long long b){return (a+=b)>=mod?a-mod:a;}
