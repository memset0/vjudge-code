...
inline void join(int a,int b){ans.push_back({'j',a,b,-1});}
inline void recolor(int a,int c1,int c2){ans.push_back({'r',a,c1,c2});}
inline void connect(int a,int c1,int c2){ans.push_back({'c',a,c1,c2});}
