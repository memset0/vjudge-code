...
const int maxn = 160, maxm = 280, maxe = 2000, inf = 1e9;
int n, m, a[maxn], b[maxm];
int u, en, s, e, sum, flow, flag, max_flow, dep[maxe], gap[maxe], cur[maxe], pre[maxe];
int tot, hed[maxe], nxt[maxe], to[maxe], val[maxe];
