...
inline bool check() {
	...
	if (ans.max - ans.min != r - l)
		return false;
	int sum21 = (calcSum2(ans.max, mod1) - calcSum2(ans.min - 1, mod1)) % mod1;
	// printf("sum21 : %d %d\n", sum21, ans.sum21);
	if (sum21 != ans.sum21) return false;
	int sum22 = (calcSum2(ans.max, mod2) - calcSum2(ans.min - 1, mod2)) % mod2;
	// printf("sum22 : %d %d\n", sum22, ans.sum22);
	if (sum22 != ans.sum22) return false;
	int sum31 = (calcSum3(ans.max, mod1) - calcSum3(ans.min - 1, mod1)) % mod1;
	// printf("sum31 : %d %d\n", sum31, ans.sum31);
	if (sum31 != ans.sum31) return false;
	int sum32 = (calcSum3(ans.max, mod2) - calcSum3(ans.min - 1, mod2)) % mod2;
	// printf("sum32 : %d %d\n", sum32, ans.sum32);
