...
//		printf("===== %d %d ====\n", l, r);
        if (bln[l] == bln[r]) {
            ...
            ans = rit[l] + lft[r] + sum[bln[l] + 1][bln[r] - 1] - sum[bln[l] + 1][bln[l]] + fur[bln[r] - 1] - fur[bln[l]];
            ans += get(bln[l] + 1, bln[r] - 1, l, fst[bln[l] + 1] - 1);
            ans -= get(bln[l] + 1, bln[r] - 1, fst[bln[r]], r);
            ans += (r - fst[bln[r]] + 1) * (fst[bln[r]] - fst[bln[l] + 1]);
            ans += merge(l, fst[bln[l] + 1] - 1, fst[bln[r]], r);
        }
        print(ans), putc('\n');
    }
